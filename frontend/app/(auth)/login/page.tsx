    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden">
      <div className="w-full max-w-md glass-panel p-8 rounded-2xl border border-cyan/30 glow-cyan space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold font-sans text-white">Sign In to VulnShield AI</h1>
          <p className="text-xs text-gray-400 font-mono">Access your vulnerability triage dashboard</p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] text-gray-500 font-mono uppercase tracking-wider">Or continue with email</span>
          <div className="flex-1 h-px bg-surface-border" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs font-mono">
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="e.g. analyst@vulnshield.ai"
                required
          ...
          >
            {submitting ? "Authenticating..." : "Sign In with Email"} <ArrowRight className="w-4 h-4" />
          </button>
        </form>
